...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        RPCConsole->setStyleSheet(QString::fromUtf8("background-image: url(:/images/gr);"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "bithercash - Debug window", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("RPCConsole", "bithercash Core", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the bithercash debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the bithercash-Qt help message to get a list with possible bithercash command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
