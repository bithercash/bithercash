...
unsigned int nStakeMinAge = 24 * 60 * 60 * 7; //Minimum stake age 15days
...
const string strMessageMagic = "bithercash Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            if(nBestHeight == 0){
                nSubsidy = 8250000 * COIN; //Total premine coin
            }
            if(nBestHeight > 0 && nBestHeight < 300) {
                nSubsidy = 10000 * COIN;
            }
            if(nBestHeight > 300 && nBestHeight < 600) {
                nSubsidy = 5000 * COIN;
            }
            if(nBestHeight > 600 && nBestHeight < 2500) {
                nSubsidy = 1000 * COIN;
            }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bithercash", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "21dec2017";
        CTransaction txNew;
        txNew.nTime = 1513847057;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1513847057;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1056454 : 1056454;
        ...
        assert(block.hashMerkleRoot == uint256("0xeb37f2d4b67b39dcdfea1eb65c3da9d6418b1e50b8c4c703d93ad5c914af94a3"));
